...
\begin{figure}[H]%
    \centering
    \subfloat[Changing only $b$]{\includegraphics[width=7cm]{Figures/doublewella.png} }%
    \qquad
    \subfloat[Changing $a$ and $b$ but keeping the ratio $a/b=2$]{\includegraphics[width=7cm]{Figures/doublewell-1.png} }%
...
\begin{figure}[H]%
    \centering
    \subfloat[Changing only $b$]{\includegraphics[width=10cm]{Figures/change_PB_a_quieto_number.png} }%
    \qquad
    \subfloat[Changing $a$ and $b$ but keeping the ratio $a/b=2$]{\includegraphics[width=10cm]{Figures/change_PB_a_b_number.png} }%
    \caption{Number of jumps between the wells as a function of the number of oscillators in the heat bath for different values for the height of the potential barrier $PB$}%
    \label{fig:changing_PB}%
\end{figure}
